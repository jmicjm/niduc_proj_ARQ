...
class Transaction_stats:
    ...
    def print(self):
        ...
        r_correct_color = bcolors.OKGREEN if self.received_correct() == self.expected_correct_count else bcolors.FAIL
        print(r_correct_color + "Stats:   - Received correct:",
              self.received_correct(), "packets out of", self.expected_correct_count, "expected")
